...
const ProductCard = ({ item }) => {
  ...
  return (
    <div className="w-full min-h-[520px]  overflow-hidden transition-all duration-300 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transform hover:-translate-y-1 flex flex-col">
