      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center mt-8 space-x-2">
          <button 
            ...
            className={`px-4 py-2 rounded-md ${currentPage === 1 ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-accent text-white hover:bg-secondary'}`}
          >
            Previous
          </button>
          ...
          <div className="flex space-x-1">
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`w-8 h-8 rounded-full ${currentPage === i + 1 ? 'bg-accent text-white' : 'bg-gray-200 hover:bg-accent'}`}
              >
                {i + 1}
              </button>
            ))}
          ...
          <button 
            ...
            className={`px-4 py-2 rounded-md ${currentPage === totalPages ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-accent text-white hover:bg-secondary'}`}
          >
            Next
          </button>
        </div>
